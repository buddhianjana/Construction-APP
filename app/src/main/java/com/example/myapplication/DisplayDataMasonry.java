...
import com.example.myapplication.Adapters.MasonryAdapter;
import com.example.myapplication.DataBase.DB;
import com.example.myapplication.DataBase.Masonry;

import java.util.ArrayList;

public class DisplayDataMasonry extends AppCompatActivity {
    DB db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_data_masonry);
    ...
    private void displayData() {
        ...
        cursor.close();
        masonryAdapter = new MasonryAdapter(this, R.layout.singledataformasonry, masonries, sqLiteDatabase);
