...
import com.example.myapplication.Adapters.SupervisorAdapter;
import com.example.myapplication.DataBase.DB;
import com.example.myapplication.DataBase.Supervisor;

import java.util.ArrayList;

public class Displaydataforsupervisor extends AppCompatActivity {
    DB db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_displaydataforsupervisor);
    ...
    private void displayData() {
        ...
        cursor.close();
        supervisorAdapter = new SupervisorAdapter(this, R.layout.singledataforsupervisor, supervisiors, sqLiteDatabase);
